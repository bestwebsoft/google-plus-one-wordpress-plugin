...
if ( ! function_exists( 'gglplsn_admin_menu' ) ) {
	function gglplsn_admin_menu() {
		bws_general_menu();
		$settings = add_submenu_page( 'bws_panel', __( 'Google +1 Settings', 'google-one' ), 'Google +1', 'manage_options', "google-plus-one.php", 'gglplsn_options' );
...
if ( ! function_exists( 'gglplsn_options' ) ) {
	function gglplsn_options() {
		...
		<div class="wrap">
			...
			<ul class="subsubsub gglplsn_how_to_use">
				<li><a href="https://docs.google.com/document/d/1v7j8TysjjBzXVnqozmfxMgjg5f7PS6XtV1GmZxnlNDk" target="_blank"><?php _e( 'How to Use Step-by-step Instruction', 'google-one' ); ?></a></li>
			</ul>
			<h2 class="nav-tab-wrapper">
				<a class="nav-tab<?php if ( ! isset( $_GET['action'] ) || ( isset( $_GET['action'] ) && ! in_array( $_GET['action'], array( 'extra', 'custom_code', 'go_pro' ) ) ) ) echo ' nav-tab-active'; ?>" href="admin.php?page=google-plus-one.php"><?php _e( 'Settings', 'google-one' ); ?></a>
				<!-- pls -->
			...
			<?php /*## check action */ if ( ! isset( $_GET['action'] ) || ( isset( $_GET['action'] ) && ! in_array( $_GET['action'], array( 'extra', 'custom_code', 'go_pro' ) ) ) ) {
						...
						<div class="gglplsn-form">
							<form method="post" action="" class="bws_form">
								...
								<?php if ( ! $bws_hide_premium_options_check ) { ?>
									<div class="gglplsn-plus-one-options <?php if ( 0 == $gglplsn_options['plus_one_js'] ) echo 'gglplsn-hide-option'; ?>">
								...
								<!-- general -->
								<?php if ( ! $bws_hide_premium_options_check ) { ?>
									<div class="bws_pro_version_bloc gglpsn-bottom-pro-block">
										<div class="bws_pro_version_table_bloc">
											<button type="submit" name="bws_hide_premium_options" class="notice-dismiss bws_hide_premium_options" title="<?php _e( 'Close', 'google-one' ); ?>"></button>
											<div class="bws_table_bg"></div>
											<table class="form-table bws_pro_version">
												<tr valign="top" class="gglplsn-pro-version-preview">
													<th>
									...
									<div class="gglplsn-preview-wrap">
										<button type="submit" name="bws_hide_premium_options" class="notice-dismiss bws_hide_premium_options" title="<?php _e( 'Close', 'google-one' ); ?>"></button>
										<div class="bws_table_bg"></div>
										<h3><?php _e( 'Preview', 'google-one' ) ?></h3>
										<img src="<?php echo plugin_dir_url( __FILE__ ); ?>/images/preview_screenshot.png">

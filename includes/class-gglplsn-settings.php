				...
				<div id="gglplsn_plus_one_enabled_pro" class="bws_pro_version_bloc">
					<div class="bws_pro_version_table_bloc">
						...
						<table class="form-table bws_pro_version">
							...
							<td>
								<label><input name="gglplsn_plus_one_entire_site" class="gglplsn-no-ajax" type="checkbox" value="1" />
								<span class="bws_info"><?php _e( 'Enable to +1 the entire website using +1 button.', 'google-one'  ); ?></span></label>
							</td>
						</table>
					</div>
